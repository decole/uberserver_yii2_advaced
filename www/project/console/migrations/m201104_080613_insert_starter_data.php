...
class m201104_080613_insert_starter_data extends Migration
{
    ...
    public function safeUp()
    {
        ...
        Yii::$app->db->createCommand()->batchInsert('shedule', ['id', 'command', 'interval', 'last_run', 'next_run', 'created', 'updated'], [
            [1, 'test/telegram', '1 minute', '2021-01-05 19:38:03', NULL, '2021-01-13 17:56:25', '2021-01-13 17:56:25'],
            [2, 'weather/index', '30 minute', '2021-01-13 21:30:05', '2021-01-13 22:00:00', '2021-01-13 17:57:06', '2021-01-13 17:57:06'],
            [3, 'gismeteo/index', '30 minute', '2021-01-13 21:30:05', '2021-01-13 22:00:00', '2021-01-13 17:57:31', '2021-01-13 17:57:31'],
            [4, 'watering/one-on', '3 days', NULL, NULL, '2021-01-13 17:57:55', '2021-01-13 17:57:55'],
            [5, 'watering/two-on', '3 days', NULL, NULL, '2021-01-13 17:58:14', '2021-01-13 17:58:14'],
            [6, 'watering/three-on', '3 days', NULL, NULL, '2021-01-13 17:58:39', '2021-01-13 17:58:39'],
            [7, 'watering/major-off', '3 days', NULL, NULL, '2021-01-13 17:59:07', '2021-01-13 17:59:07'],
        ])->execute();
    }
    ...
    public function safeDown()
    {
        ...
        Yii::$app->db->createCommand()->truncateTable('shedule')->execute();
    }
}
